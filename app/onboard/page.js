...
export default function Onboard() {
  ...
  const [form, setForm] = useState({
    ...
    mixing_device: '', number_of_residence_tanks: '',
  ...
  const submit = async () => {
    ...
    const { error } = await supabase
      ...
      .insert({
        ...
        mixing_device: form.mixing_device,
  ...
  const steps = [
    ...
    <div key={2}>
      ...
      {sel('Caustic mixing device', 'mixing_device', ['Micro-zone','Static mixer','In-line pump','Distributed quills','Batch agitator'])}
      <div style={{marginBottom:16}}>
    ...
    <div key={4}>
      ...
      {[
        ...
        ['Mixing device', form.mixing_device || '—'],

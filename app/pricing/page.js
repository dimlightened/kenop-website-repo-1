    ...
    <>
      ...
      <nav style={{ padding:'0 32px', height:52, display:'flex', alignItems:'center', justifyContent:'space-between', borderBottom:`0.5px solid ${C.border}`, background:C.bgCard }}>
        ...
        <div style={{ display:'flex', alignItems:'center', gap:20 }}>
          ...
          <button onClick={() => router.push('/start')} style={{ ...D({ fontSize:12, fontWeight:500, background:C.green, border:'none', color:'#fff', padding:'6px 16px', borderRadius:6, cursor:'pointer' }) }}>Start 72-hr free trial →</button>
        </div>
      </nav>

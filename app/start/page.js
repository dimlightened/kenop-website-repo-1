  ...
  if (done) return (
    <div style={{minHeight:'100vh',background:C.bg,display:'flex',alignItems:'center',justifyContent:'center',padding:24}}>
      <div style={{maxWidth:420,width:'100%',textAlign:'center'}}>
        ...
        <h1 style={{fontFamily:"'Fraunces',Georgia,serif",fontSize:26,fontWeight:700,color:C.text,marginBottom:12,letterSpacing:'-0.5px'}}>
          Check your email
        </h1>
        <p style={{fontFamily:"'DM Sans',sans-serif",fontSize:15,color:C.light,fontWeight:300,lineHeight:1.7,marginBottom:8}}>
          We sent a login link to
        </p>
        <p style={{fontFamily:"'JetBrains Mono',monospace",fontSize:14,color:C.text,marginBottom:20}}>
          {form.email}
        </p>
        <p style={{fontFamily:"'DM Sans',sans-serif",fontSize:14,color:C.light,fontWeight:300,lineHeight:1.7}}>
          Click the link to access your Kenop dashboard and complete plant setup. No password needed.
        </p>
      </div>
    </div>
  )
    ...
    <div style={{minHeight:'100vh',background:C.bg,display:'flex',alignItems:'center',justifyContent:'center',padding:24}}>
      <div style={{width:'100%',maxWidth:440}}>
        <div style={{textAlign:'center',marginBottom:32}}>
          <span style={{fontFamily:"'Fraunces',Georgia,serif",fontSize:24,fontWeight:700,color:C.text}}>
            Ken<span style={{color:C.green}}>op</span>
          </span>
          <span style={{marginLeft:10,padding:'2px 10px',background:'rgba(29,158,117,0.1)',borderRadius:20,
            fontFamily:"'JetBrains Mono',monospace",fontSize:9,color:C.green,letterSpacing:'0.12em'}}>
        ...
        <div style={{background:C.card,border:'0.5px solid ' + C.border,borderRadius:14,padding:'32px 28px'}}>
          ...
          <p style={{fontFamily:"'DM Sans',sans-serif",fontSize:13,color:C.light,marginBottom:24,fontWeight:300}}>
            Set up your plant intelligence in 5 minutes
          </p>
          <form onSubmit={submit}>
            {fields.map(f => (
              <div key={f.key} style={{marginBottom:16}}>
                <label style={{fontFamily:"'JetBrains Mono',monospace",fontSize:9,color:C.light,
            ...
            <p style={{fontFamily:"'DM Sans',sans-serif",fontSize:11,color:C.light,
              textAlign:'center',marginTop:14,fontWeight:300}}>
              We will send a login link to your email. No password needed.
            </p>
          </form>
        </div>
      </div>
